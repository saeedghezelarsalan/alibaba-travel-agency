      ...
      >
        <div className="hidden lg:flex h-full max-w-screen-2xl mx-auto text-base bg-transparent  xl:px-2 xl:mx-2 2xl:mx-auto ">
          <nav className="hidden lg:!flex !h-full !items-center w-full ">
                ...
                <div className="flex">
                  ...
                  <div className="flex flex-col justify-center  ">
                    ...
                    <p className="text-[10px] font-thin pt-1">
                      ...
                      {lang == "fa" ? "خرید بلیط، هتل و تور" : "buy ticket, hotel and tour"}
                    </p>
                  </div>
                </div>
              </a>
            ...
            >
              {/* <li className="relative"  ref={flights}>
                  <div  className="flex items-center" > */}

              {/* dropdown */}
              {/* <ul className={ 'absolute flex flex-col items-center w-max h-auto  bg-white shadow-lg -bottom-[5.5rem] border border-vehiclsContainer -right-2  z-10 rounded-md p-1.5' : "hidden"}>
                    <li className='p-2 text-sm w-auto'>پرواز داخلی</li>
                    <li className='w-auto h-[1px] bg-[#0000001A] dark:bg-white  self-stretch mx-3 min-w-[1px] max-w-full'></li>
                    <li  className='p-2 text-sm w-auto'>پرواز خارجی</li>
                  </ul> */}
