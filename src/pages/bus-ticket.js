...
import MainBusTravel from "../components/Form/mainTravelDetailsForm/MainBusTravel";
import BusTravel from "../components/Form/smallTravelDetailsForm/BusTravel";
...
import {BusAccordion} from "../data/accordion/bus";
...
const Home = () => {
  ...
  return (
    <div className="flex flex-col lg:mt-16 bg-[#F6F6F6] dark:bg-[#222222] h-auto ">
      <Head>
        <title>بلیط اتوبوس - خرید بلیط اتوبوس | علی‌بابا</title>
        <meta
          name="description"
      ...
      <div className="mx-4 xl:!w-4/5 xl:mx-auto  2xl:!px-16 2xl:!w-4/5 -mt-4  !z-[2] ">
        <MainBusTravel iranState={iranState}/>
        <BusTravel iranState={iranState}/>
      </div>
