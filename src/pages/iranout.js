...
import VehicleTravel from "../components/Form/smallTravelDetailsForm/VehicleTravel";
...
import {InternationalFlightAccordion} from "../data/accordion/international-flight";
...
const Home = () => {
  ...
  const accordion = InternationalFlightAccordion;
  ...
  return (
    <div className="flex flex-col lg:mt-16 bg-[#F6F6F6] dark:bg-[#222222] h-auto ">
      ...
      <div className="mx-4 xl:!w-4/5 xl:mx-auto  2xl:!px-16 2xl:!w-4/5 -mt-4  !z-[2] ">
        ...
        <VehicleTravel iranState={iranState}/>
      </div>
