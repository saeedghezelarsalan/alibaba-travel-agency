...
import {DomesticFlightAccordion} from "../data/accordion/domestic-flight";
...
const Home = () => {
  ...
  const accordion = DomesticFlightAccordion;
        ...
        >
          <div className="flex items-center mb-2">
            ...
            <button className="mr-auto" onClick={clickHandler}>
              ...
              >
                <path
                  d="m5.335 4.282.07.063L12 10.939l6.595-6.594a.75.75 0 0 1 1.123.99l-.063.07L13.061 12l6.594 6.595a.75.75 0 0 1-.99 1.123l-.07-.063L12 13.061l-6.595 6.594a.75.75 0 0 1-1.123-.99l.063-.07L10.939 12 4.345 5.405a.75.75 0 0 1 .99-1.123Z"></path>
              </svg>
            </button>
          </div>
          ...
          <button className="flex items-center text-xs text-blue-400 dark:text-[#07ce39] py-1 px-2">
            ...
            >
              <path
                d="M16.698 21.266a.75.75 0 0 1-1.08 1.037l-.066-.069-8.25-9.75a.75.75 0 0 1-.058-.89l.058-.078 8.25-9.75a.75.75 0 0 1 1.202.893l-.056.075L8.858 12l7.84 9.266Z"></path>
            </svg>
          </button>
        </div>
