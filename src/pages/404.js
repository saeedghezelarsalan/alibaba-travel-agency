...
export const getStaticProps = async ({locale}) => {
  ...
  let accordion = await axios.get('http://alibaba-travel-agency-emwbmggkk-saeedghezelarsalan.vercel.app/domesticFlightAccordion')
  accordion = accordion.data
  let homePageDescription = await axios.get('http://alibaba-travel-agency-emwbmggkk-saeedghezelarsalan.vercel.app/domesticFlightDescription')
  homePageDescription = homePageDescription.data
  let iranState = await axios.get('http://alibaba-travel-agency-emwbmggkk-saeedghezelarsalan.vercel.app/iranState')
