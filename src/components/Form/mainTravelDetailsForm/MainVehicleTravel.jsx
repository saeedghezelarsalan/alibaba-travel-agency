...
const MainVehicleTravel = ({ iranState }) => {
  ...
  return (
    <div className="hidden lg:flex lg:border-x-0 lg:border-b-0 lg:border  w-full h-auto lg:-translate-y-4 pb-10 pt-6 lg:px-4 text-black border-vehiclsContainer shadow-sm bg-white dark:border-black  dark:bg-[#1b344d] rounded-bl-xl rounded-br-xl max-w-screen-2xl mx-auto px-4 flex-col !-mt-[27px]  maxh-h-auto">
...
export default MainVehicleTravel;